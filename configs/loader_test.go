...
func clearEnv(t *testing.T) {
	...
	for _, key := range []string{
		...
		"MSCLI_MICROCOMPACT_IDLE_MINUTES",
		"MSCLI_MICROCOMPACT_KEEP_RECENT",
		"MSCLI_AUTOCOMPACT_BUFFER_TOKENS",
		"MSCLI_AUTOCOMPACT_MIN_TAIL_TOKENS",
		"MSCLI_AUTOCOMPACT_MAX_TAIL_TOKENS",
		"MSCLI_AUTOCOMPACT_MIN_MESSAGES",
		"MSCLI_UI_ENABLED",
